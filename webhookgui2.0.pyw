...
# Set initial size
root.geometry("500x900")  # Height set to 900
...
private_message_entry.pack(pady=5)
tk.Button(root, text="Send Private Message", command=send_private_message).pack(pady=10)
...
spam_message_entry.pack(pady=5)
...
spam_count_entry.pack(pady=5)
tk.Button(root, text="Spam Message", command=spam_message).pack(pady=10)

# Send File Section
tk.Label(root, text="- Send File -").pack(pady=10)
tk.Button(root, text="Select File", command=send_file).pack(pady=10)
...
collect_info_target_entry.pack(pady=5)
tk.Button(root, text="Collect Info", command=collect_info).pack(pady=10)
...
tk.Button(root, text="Send Skid Hunter Message", command=send_skid_hunter_message).pack(side=tk.LEFT, padx=10, pady=10)
tk.Button(root, text="Delete Webhook", command=delete_webhook).pack(side=tk.RIGHT, padx=10, pady=10)
